 ...
 * @public
 */
export const sampleAesEncryptAudioFrame = (frame: Uint8Array, options: SampleAesOptions): Uint8Array => {
 ...
 * @public
 */
export const sampleAesEncryptVideoNal = (nal: Uint8Array, options: SampleAesOptions): Uint8Array => {
